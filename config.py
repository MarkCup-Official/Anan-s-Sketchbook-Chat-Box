...
TEXT_BOX_TOPLEFT= (80, 290)

# 文本框右下角坐标 (x, y), 同时适用于图片框
# 此值为一个二元组, 例如 (100, 150), 单位像素, 图片的左上角记为 (0, 0)
IMAGE_BOX_BOTTOMRIGHT= (80+279, 290+175)

# 图片尺寸与文本框位置的映射配置
# 格式: "图片文件名": (TEXT_BOX_TOPLEFT, IMAGE_BOX_BOTTOMRIGHT)
IMAGE_BOX_CONFIGS = {
    # 默认配置（用于未特别指定的图片）
    "default": (TEXT_BOX_TOPLEFT, IMAGE_BOX_BOTTOMRIGHT),
    
    # 在这里添加你自定义图片的配置
    "ananQ.png": ((80, 290), (80+279, 290+175)),
    "趴下.png": ((105, 310), (80+285, 290+138)),
    "base.png": ((119, 450), (119+279, 450+175)),
    "开心.png": ((119, 450), (119+279, 450+175)),
    "生气.png": ((119, 450), (119+279, 450+175)),
    "无语.png": ((119, 450), (119+279, 450+175)),
    "脸红.png": ((119, 450), (119+279, 450+175)),
    "病娇.png": ((119, 450), (119+279, 450+175)),
    # 格式: "你的图片文件名": ((左上角x, 左上角y), (右下角x, 右下角y))
    # 示例:
    # "my_custom_image.png": ((50, 100), (50+300, 100+200)),
}
